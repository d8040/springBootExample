...
<section class="section-1">
	<div class="bg-white shadow-md rounded container mx-auto p-8 mt-8">
		<div class="flex itmes-center">
			...
			<a href="add?boardId=${board.id}" class="btn-primary bg-blue-500 hover:bg-blue-dark text-white forn-bold py-2 px-4 rounded">글쓰기</a>
		</div>
		<div>
			<c:forEach items="${articles}" var="article">
				...
				<div class="flex items-center mt-4">
					<a href="${detailUrl}" class="text-blue-500 hover:underline">자세히 보기</a>
					...
					<div class="flex-grow"></div>
					<div>
						<a href="${detailUrl}" class="flex items-center">
