			...
			<c:forEach begin="1" end="${fileInputMaxCount}" var="inputNo">
				...
				<div class="form-row flex flex-col lg:flex-row">
					...
					<div class="lg:flex-grow input-file-wrap">
						...
						<c:if test="${file != null}">
							<div>
								<a href="${file.forPrintUrl}" target="_black" class="text-blue-500 hover:underline" href="#">${file.fileName}</a> (${Util.numberFormat(file.fileSize)}byte)
							</div>
							<div>
								<label> 
							...
							<c:if test="${file.fileExtTypeCode == 'img'}">
								<div class="img-box img-box-auto">
									<a href="${file.forPrintUrl}" class="inline-block" target="_blank" title="자세히 보기"> <img src="${file.forPrintUrl}" class="max-w-2xl" />
									</a>
								</div>
							</c:if>
						</c:if>
